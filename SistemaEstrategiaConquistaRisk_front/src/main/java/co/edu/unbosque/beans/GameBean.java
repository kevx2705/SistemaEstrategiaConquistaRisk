...
/**
 * Bean principal que controla la lógica del juego tipo Risk. Maneja jugadores,
 * turnos, territorios y acciones como ataque, movimiento, refuerzo y asignación
 * de tropas.
 *
 * Este bean se mantiene vivo durante toda la sesión del usuario debido a la
 * anotación {@link SessionScoped}.
 */
@Named("gameBean")
@SessionScoped
public class GameBean implements Serializable {
	...
	/**
	 * Inicializador ejecutado al cargar el bean. Configura jugadores iniciales,
	 * estado del turno, listas de territorios y dados.
	 */
	@PostConstruct
	public void init() {
	...
	public void canjearCartas() {

	}

	/**
	 * Genera la lista inicial de jugadores según {@link #numJugadores}. También
	 * configura el primer jugador como el jugador actual.
	 */
	...
	/**
	 * Cambia el turno al siguiente jugador utilizando la estructura circular de
	 * {@link MyDequeList}.
	 */
	...
	/**
	 * Valida los nombres de los jugadores e inicia la partida, redirigiendo al
	 * tablero.
	 *
	...
	/**
	 * Simula un ataque generando valores fijos para los dados de atacante y
	 * defensor.
	 */
