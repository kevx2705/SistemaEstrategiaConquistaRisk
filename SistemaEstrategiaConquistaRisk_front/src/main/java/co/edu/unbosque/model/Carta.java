...
/**
 * Clase que representa una carta en el juego. Cada carta tiene un identificador
 * único, un nombre, un tipo y un estado de disponibilidad.
 */
public class Carta {
	...
	public Carta(Long id, String nombre, String tipo, boolean disponible, String territorio) {
		super();
		this.id = id;
		this.nombre = nombre;
		this.tipo = tipo;
	 ...
	 *
	 * @return {@code true} si la carta está disponible, {@code false} en caso
	 *         contrario.
	 */
