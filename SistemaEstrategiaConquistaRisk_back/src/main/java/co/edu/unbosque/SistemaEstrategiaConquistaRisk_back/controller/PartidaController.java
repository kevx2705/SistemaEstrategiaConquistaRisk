...
/**
 * Controlador REST para la gestión de partidas en el juego Risk.
 * Proporciona endpoints para crear, inicializar, reclamar territorios, atacar,
 * mover tropas, canjear cartas, eliminar jugadores, retomar partidas, verificar el fin de una partida,
 * listar partidas y descargar resultados finales.
 */
@RestController
...
public class PartidaController {
     ...
     * <p><strong>Nota:</strong> Este método es temporal y debe ser eliminado en producción.</p>
     *
     ...
     * @return ResponseEntity con el resultado del ataque en formato ResultadoAtaqueDTO.
     */
    ...
    /**
     * Verifica si una partida ha finalizado y devuelve el identificador del ganador.
     *
     * @param id Identificador de la partida.
     * @return ResponseEntity con el identificador del ganador, o null si la partida no ha finalizado.
     */
    @GetMapping("/{id}/fin")
     ...
     *
     * @return ResponseEntity con la lista de partidas, o un mensaje de error si ocurre una excepción.
     */
    @GetMapping("/listar")
     ...
     * @return ResponseEntity con el archivo ZIP adjunto, o un mensaje de error si ocurre una excepción.
     */
