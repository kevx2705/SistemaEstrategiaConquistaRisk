...
/**
 * Clase DTO que representa una partida en el juego Risk.
 * Contiene información sobre el estado de la partida, el código hash único,
 * el ganador, el jugador actual, los territorios, las cartas, el orden de turno de los jugadores,
 * y las fechas de inicio y fin de la partida.
 */
public class PartidaDTO {
     ...
     * @param iniciada                 Estado que indica si la partida ha sido iniciada.
     ...
     * @param jugadoresOrdenTurnoJSON  Representación en JSON del orden de turno de los jugadores.
